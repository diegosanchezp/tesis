...
from django_src.business.register.view import register_business_view
...
urlpatterns = [
    ...
    path(
        "select_carreer_specialization/<str:name>",
        SelectCarrerSpecialization.as_view(),
    ...
    path("business/", register_business_view, name="bussines"),
    # Todo
