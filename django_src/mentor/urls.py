...
from .mentorship_view import (
    create_mentorship,
    make_mentorship_request,
...
from .edit_profile.view import edit_profile_view
...
urlpatterns = [
    ...
    path(
        "mentorship/<int:mentorship_pk>",
        mentorship_detail_view,
        name="mentorship_detail",
    ),
    path("mentorship/create", create_mentorship, name="create_mentorship"),
    path(
        "mentorship/edit/<int:mentorship_pk>",
        edit_mentorship_view,
        name="edit_mentorship",
    ),
    path(
        "mentorship/delete/<int:mentorship_pk>",
        delete_mentorship,
        name="delete_mentorship",
    ),
    path("mentorship/delete_task/<int:task_pk>", delete_task, name="delete_task"),
    path(
        "mentorship/student_info/<int:mentorship_request_pk>",
        student_info_view,
        name="student_info_modal",
    ),
    path(
        "mentorship/request/<int:mentorship_pk>",
        make_mentorship_request,
        name="request_mentorship",
    ),
    path(
        "mentorship/request/tasks/<int:mentorship_pk>",
        get_mentorship_tasks,
        name="get_tasks",
    ),
    path(
        "mentorship/request/change_status/<int:mentorship_req_pk>",
        change_mentorship_status,
        name="change_mentorship_status",
    ),
]
